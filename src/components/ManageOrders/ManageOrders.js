...
const ManageOrders = () => {
  ...
  useEffect(() => {
    axios
      .get("https://infinite-springs-03391.herokuapp.com/manageAllOrders")
  ...
  const handleDelete = (id) => {
    ...
    if (proceed) {
      axios
        .delete(
          `https://infinite-springs-03391.herokuapp.com/deleteOrder/${id}`
        )
        .then((res) => {
  ...
  const handleEditStatus = (id) => {
    axios
      .put(`https://infinite-springs-03391.herokuapp.com/updateStatus/${id}`)
      .then((res) => {
